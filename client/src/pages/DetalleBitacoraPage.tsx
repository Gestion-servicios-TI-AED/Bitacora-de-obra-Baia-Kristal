                                ...
                                <div className="rounded-xl border-2 border-primary bg-primary/5 p-6 shadow-sm flex flex-col h-full ring-4 ring-primary/10">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            placeholder="Ingrese sus observaciones, instrucciones o comentarios sobre este informe..."
                                            className="w-full px-3 py-2.5 text-sm bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-none text-slate-700 placeholder:text-slate-400"
                                        />
                                        {!comentariosDirector.trim() && (
                                            <p className="text-xs text-rose-500 mt-1">Este campo es requerido para emitir el aval.</p>
                                        )}
                                    </div>
                                    <label className={`flex items-start gap-4 mb-5 flex-1 group ${comentariosDirector.trim() ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'}`}>
                                ...
                                <div className="flex flex-col gap-3 h-full">
                                    ...
                                    {bitacora.comentariosDirector && (
                                        <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl">
                                            <span className="text-xs font-semibold text-primary/70 uppercase tracking-wider block mb-1.5">Observaciones del Director</span>
                                            <p className="text-sm text-slate-700 leading-relaxed whitespace-pre-wrap">{bitacora.comentariosDirector}</p>
                                        </div>
                                    )}
                                </div>
                            )}
                        ...
                        <div className="h-full flex flex-col">
                            {canSignInterventor ? (
                                <div className="rounded-xl border-2 border-primary bg-primary/5 p-6 shadow-sm flex flex-col h-full ring-4 ring-primary/10">
                                    ...
                                    <label className={`flex items-start gap-4 mb-5 flex-1 group ${comentariosInterventor.trim() ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'}`}>
                                        <div className="relative flex items-center justify-center shrink-0 mt-0.5">
